...
<div x-data="{ showAllActivities: false }">
                ...
                <button class="text-xs bg-red-50 hover:bg-red-100 text-red-700 font-medium py-1 px-3 rounded-md border border-red-200 transition-colors duration-200 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M4.293 4.293a1 1
                      0 011.414 0L10 8.586l4.293-4.293a1 1
        ...
        <div
            ...
            <div class="p-6 overflow-y-auto max-h-[60vh]">
                <ul class="space-y-4 relative">
                                ...
                                <div class="bg-gray-50 rounded-lg p-3 border border-gray-100 shadow-sm">
                                    ...
                                    <div class="mt-1 flex items-center space-x-2">
                                        ...
                                        @if(isset($activity['causer']))
                                            <span class="text-xs text-gray-400">by {{ $activity['causer'] }}</span>
                                        @endif
                                        @if(isset($activity['priority']) && $activity['priority'] === 'high')
                                            <span class="inline-flex items-center rounded-full bg-red-100 px-2 py-0.5 text-xs font-medium text-red-700">
                                                High Priority
                    ...
                    @empty
                        <li class="text-center text-sm text-gray-500 py-8">
