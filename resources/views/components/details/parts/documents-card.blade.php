...
<div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-lg">
    ...
    <div class="p-6">
        ...
        <div class="space-y-3" x-data="{ openApplication: null }">
            ...
            <livewire:admin.applicant.details.documents.document-accordion wire:key="$application['id']" :index="$index" :application="$application" :application_id="$application['application_id']" />
            @endforeach
        </div>
