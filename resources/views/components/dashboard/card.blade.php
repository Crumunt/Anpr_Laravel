...
<div>
    <div class="group relative rounded-2xl border bg-white border-{{$color}}-50 transition-all duration-300 hover:border-transparent hover:-translate-y-1 shadow-sm hover:shadow-lg overflow-hidden hover:bg-gradient-to-br from-white to-{{$color}}-50/30">
        <div class="absolute inset-0 bg-{{$color}}-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div class="p-5 sm:p-6">
            <div class="flex justify-between items-start">
                <div class="relative z-10">
                    <p class="text-sm font-medium text-gray-500 mb-2 transition-colors duration-300 group-hover:text-{{ $color }}-700">
                        {{ $title }}</p>
                    <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-{{ $color }}-900">
                        {{ $totalNumber }}</h3>
                ...
                <div class="p-2.5 sm:p-3 rounded-full bg-{{$color}}-50/80 backdrop-blur-sm transition-all duration-300 group-hover:bg-{{$color}}-100/90 group-hover:scale-110">
                    @if($icon == 'users')
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-7 w-7 sm:h-8 sm:w-8 text-{{$color}}-600 transition-colors duration-300 group-hover:text-{{$color}}-700"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                        <path d="M20 6v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v2h1a1 1 0 0 1 1 1z"/>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path fill="currentColor" opacity="0.2" d="M12 3l5 2v4c0 3.09-2.66 6.69-5 8-2.34-1.31-5-4.91-5-8V5l5-2z" transform="translate(9, 7) scale(0.5)"/>
                    </svg>
                    @endif
                </div>
            </div>
