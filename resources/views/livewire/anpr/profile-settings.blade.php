                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $user->details->license_number }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 pt-4 border-t border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $user->details->college_unit_department }}</p>
                            </div>
                            @endif
                            @if($user->details?->position)
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">Position</label>
                                <p class="text-sm text-gray-900">{{ $user->details->position }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
