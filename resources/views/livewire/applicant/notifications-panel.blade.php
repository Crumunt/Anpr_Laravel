                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <button
                            ...
                            class="mt-2 inline-flex items-center px-3 py-1.5 bg-emerald-100 text-emerald-700 text-xs font-semibold rounded-lg hover:bg-emerald-200 transition-colors">
                ...
                <form wire:submit.prevent="resubmitDocument">
                    <div class="bg-white px-6 pt-6 pb-4">
                        ...
                        <div>
                            ...
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-emerald-400 transition-colors cursor-pointer"
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3">
                        ...
                        <button
                            ...
                            class="px-4 py-2 bg-emerald-600 text-white font-medium rounded-lg hover:bg-emerald-700 transition-colors flex items-center gap-2">
