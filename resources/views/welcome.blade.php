...
<body style="background-color: #f9fafb;">
    <div class="flex-1 md:ml-64 p-6 pt-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <x-dashboard.card title="Total Applicants" totalNumber="1,111" percent="+2" description="Total registered applicants" icon="users" />
            <x-dashboard.card title="Active Gate Pass Stickers" totalNumber="894" percent="+2" description="Currently Active RFID Tags" icon="rfid" />
            <x-dashboard.card title="Registered Vehicles" totalNumber="115" percent="+5" description="Total registered vehicles" icon="car" />
            <x-dashboard.card title="Pending Approvals" color="red" totalNumber="1,111" percent="-12" description="Total registered applicants" icon="approval" />
        </div>
        <!-- Use ONE Alpine.js data context for the entire section -->
        <div x-data="{ activeTab: 'Applicants' }" class="w-full bg-white rounded-xl shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md">
                ...
                <div class="w-full space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <h2 class="text-2xl font-bold text-gray-800">
                            <span x-text="activeTab === 'Applicants' ? 'Applicants Management' : (activeTab === 'Registered Vehicles' ? 'Vehicle Management' : 'RFID Management')"></span>
                        </h2>
                        <div class="flex space-x-2">
                            ...
                            <!-- Vehicle Button -->
                            <!-- <div x-show="activeTab === 'Registered Vehicles'">
                                <x-dashboard.buttons
                                    :icon="false"
                                    class="bg-emerald-600 hover:bg-emerald-700"
                            ...
                            <!-- RFID Button -->
                            <!-- <div x-show="activeTab !== 'Applicants' && activeTab !== 'Registered Vehicles'">
                                <x-dashboard.buttons
                                    :icon="false"
                                    class="bg-emerald-600 hover:bg-emerald-700"
                    ...
                    <div class="w-full space-y-6">        
                        ...
                        <div x-show="activeTab === 'RFID Management'" x-transition>
                            <x-dashboard.application-table
                                :type="'rfid'"
                                :headers="[ 
                                ...
                                :rows="[ 
                                        ...
                                        ['rfid_tag' => 'RFID67890', 'status' => 'Pending', 'assigned_to' => 'Jane Smith'],
                                        ['rfid_tag' => 'RFID67890', 'status' => 'Red', 'assigned_to' => 'Jane Smith'],
                                        ['rfid_tag' => 'RFID67890', 'status' => 'Default', 'assigned_to' => 'Jane Smith'],
                                    ]"
