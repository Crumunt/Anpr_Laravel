...
/**
 * Profile Settings for applicant users.
 */
...
class ProfileSettings extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->user->load(['details', 'vehicles.status']);
     ...
     */
    protected function calculateVehicleStats(): void
    {
        $vehicles = $this->user->vehicles;

        $this->vehicleStats = [
            'total' => $vehicles->count(),
            'active' => $vehicles->filter(fn($v) => $v->status?->status_name === 'approved')->count(),
            'pending' => $vehicles->filter(fn($v) => in_array($v->status?->status_name, ['pending', 'pending_review']))->count(),
        ];
    }
    ...
    public function updateProfile(): void
    {
        ...
        try {
            ...
            Log::info('Applicant profile updated', [
                'user_id' => $this->user->id,
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function updateEmail(): void
    {
        ...
        try {
            ...
            Log::info('Applicant email updated', [
                'user_id' => $this->user->id,
                'old_email' => $oldEmail,
    ...
    public function updatePassword(): void
    {
        ...
        try {
            ...
            Log::info('Applicant password updated', ['user_id' => $this->user->id]);
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.applicant.profile-settings');
    }
}
